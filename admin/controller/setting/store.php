...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->error['error_email_service'])) {
			$data['error_email_service'] = $this->error['error_email_service'];
		} else {
			$data['error_email_service'] = '';
		}
		...
		if (isset($this->request->post['config_email_service'])) {
			$data['config_email_service'] = $this->request->post['config_email_service'];
		} elseif (isset($store_info['config_email_service'])) {
			$data['config_email_service'] = $store_info['config_email_service'];
		} else {
			$data['config_email_service'] = '';
		}
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['config_email_service']) > 96) || !filter_var($this->request->post['config_email_service'], FILTER_VALIDATE_EMAIL)) {
			$this->error['error_email_service'] = $this->language->get('error_email');
		}
