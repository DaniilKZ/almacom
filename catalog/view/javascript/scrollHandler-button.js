        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                if (nextUrl) {
                    ...
                    $(".ScrollHandler").removeClass('d-none').attr('disable', false);

                } else {
                    _nextPageUrl = null;

                    $(".loading-css").addClass('d-none');
                    $(".ScrollHandler").addClass('d-none').attr('disable', true);

                    $(window).off('scroll', ScrollHandler);
                    console.log('nextUrl else');
                }
...
$(document).ready(function () {
    ...
    if (_nextPageUrl) {
        ...
        $(document).on('click', '.ScrollHandler', function(){
                $(".loading-css").removeClass('d-none').attr('disable', false);
                ScrollHandler();
        });
    }else{
        $(".loading-css").addClass('d-none').attr('disable', true);
    }
});