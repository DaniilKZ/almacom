...
class ControllerMailCallback extends Controller {
    ...
    public function index() {
        ...
        // from ($this->config->get('config_email')); //или это можно использовать $this->config->get('config_mail_parameter') 
        // $this->request->post['your_name']  //Данные пост запроса
        // $this->request->post['your_phone'] //Данные пост запроса
