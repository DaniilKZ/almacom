...
$_['text_price_asc']    = '<span>Сначала дешевле</span> <i class="sprite sprite-sort-desc rotated"><svg><use xlink:href="#sort-desc"></use></svg></i>';
$_['text_price_desc']   = '<span>Сначала дороже</span> <i class="sprite sprite-sort-desc"><svg><use xlink:href="#sort-desc"></use></svg></i>';
// $_['text_rating_asc']   = '';
$_['text_rating_desc']  = '<span>Сначала популярные</span> <i class="sprite sprite-sort-desc"><svg><use xlink:href="#sort-desc"></use></svg></i>';
