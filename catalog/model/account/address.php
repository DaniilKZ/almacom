...
class ModelAccountAddress extends Model {
	public function addAddress($customer_id, $data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', company = 'null', address_1 = '" . $this->db->escape($data['address_1']) . "', address_2 = 'null', postcode = 'null', city = '" . $this->db->escape($data['city']) . "', zone_id = 'null', country_id = 'null', custom_field = '" . $this->db->escape(isset($data['custom_field']['address']) ? json_encode($data['custom_field']['address']) : '') . "'");
